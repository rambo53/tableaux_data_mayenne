...
' =========================================================================
                        ...
                        Else
                            ...
                            If DerniereLigneSource > 0 _
                               And DerniereColSource > 0 Then
                                ...
                                If DictPremiereSource(NomOngletDestination) = True Then
                                    WsDestination.Cells(1, 1).Resize( _
                                        DerniereLigneSource, _
                                        DerniereColSource _
                                    ).Value = WsSource.Cells(1, 1).Resize( _
                                        DerniereLigneSource, _
                                        DerniereColSource _
                                    ).Value
                                    
                                    DictPremiereSource(NomOngletDestination) = False
                                ...
                                Else
                                    ...
                                    If DerniereLigneSource >= 4 Then
                                        ...
                                        WsDestination.Cells(LigneDestination, 1).Resize( _
                                            DerniereLigneSource - 3, _
                                            DerniereColSource _
                                        ).Value = WsSource.Cells(4, 1).Resize( _
                                            DerniereLigneSource - 3, _
                                            DerniereColSource _
                                        ).Value
    ...
    Sub FermerWorkbookSiOuvert(ByVal Wk As Workbook)
